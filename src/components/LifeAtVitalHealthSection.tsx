...
const LifeAtVitalHealthSection = () => (
  <section className="py-0 bg-background">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 grid md:grid-cols-2 gap-6 md:gap-8 mt-8">
      ...
      >
        <img src={communityImg} alt="Community life at Vital Health" className="w-full h-full object-cover" loading="lazy" />
      </motion.div>
      <motion.div
        initial={{ opacity: 0, x: 30 }}
        whileInView={{ opacity: 1, x: 0 }}
        ...
        className="relative overflow-hidden aspect-[4/3] rounded-3xl"
      >
        <img src={walkingImg} alt="Supportive care at Vital Health" className="w-full h-full object-cover" loading="lazy" />
      </motion.div>
    </div>
  </section>
);
