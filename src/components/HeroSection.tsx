  ...
  return (
    <section className="relative min-h-[100dvh] sm:min-h-[92vh] flex overflow-hidden pt-24 pb-6 sm:py-32">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center lg:text-left h-full flex flex-col justify-end sm:justify-center">
        ...
        >
          <div className="inline-block bg-primary text-primary-foreground font-body font-semibold text-xs sm:text-sm px-4 py-1.5 sm:px-5 sm:py-2 rounded-full mb-4 sm:mb-6">
            Serving Virginia Families Since 2020
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-extrabold text-[#111111] leading-tight mb-4 sm:mb-6">
            Residential Care in <br className="hidden sm:block" />
            <span className="text-primary">Virginia</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-[#333] font-body mb-6 sm:mb-8 max-w-2xl text-center lg:text-left font-medium">
          ...
          <div className="bg-white/95 backdrop-blur border-l-4 border-l-primary rounded-r-xl rounded-l-sm p-5 sm:p-6 mb-8 sm:mb-10 max-w-2xl mx-auto lg:mx-0 text-left shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 justify-center lg:justify-start w-full sm:w-auto mt-2 sm:mt-0">
